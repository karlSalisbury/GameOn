...
<?php 
     ...
     { 
         $_SESSION['error'] = 'Password must be 8 characters or more.'; //if password is less than 8 characters intialise a session called 'error' to have a value of the error msg 
     ...
     { 
         ...
         $sql = "UPDATE admin SET password='$password', salt='$salt' WHERE adminID='$adminID'"; 
